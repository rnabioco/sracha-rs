...
```bash
# Docker / Podman
docker run --rm quay.io/biocontainers/sracha:0.5.0--h54198d6_0 sracha --help

# Singularity / Apptainer
singularity run \
  https://depot.galaxyproject.org/singularity/sracha:0.5.0--h54198d6_0 sracha --help
```
...
```groovy
process SRACHA_GET {
    container 'quay.io/biocontainers/sracha:0.5.0--h54198d6_0'
    // or: conda 'bioconda::sracha=0.5.0'
    // ...
}
```
